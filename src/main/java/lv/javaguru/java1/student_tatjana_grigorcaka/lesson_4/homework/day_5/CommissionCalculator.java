 ...
 class CommissionCalculator {
    ...
    public static void main(String[] args) {
        ...
        if (amount < 1000) {
            ...
            System.out.println("Commission amount is 3% - " + commission1);
        }else if ((amount >= 1000) && (amount <= 5000)) {
            double commission2 = (amount * 4) / 100;
            System.out.println("Commission amount  is 4%: " + commission2);
        }else if (amount > 5000) {
            double commission3 = (amount * 5) / 100;
            System.out.println("Commission amount is 5%: " + commission3);
