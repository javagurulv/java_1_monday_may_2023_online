...
public class StockTest {
    public static void main(String[] args) { //изначальные переменные
        ...
        System.out.println("Name of organization and its prices for a month: " + information);
        ...
        System.out.println("Last information update: " + newinformation);  //обновленный результат
