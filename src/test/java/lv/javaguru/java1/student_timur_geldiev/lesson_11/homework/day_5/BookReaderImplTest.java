...
class BookReaderImplTest {
    ...
    void addBook() {
        ...
        BookReader check = new BookReaderImpl();
        boolean actual = check.addBook(testBook);
    ...
    void isAdded() {
        ...
        boolean actual = check.isAdded(testBook);
        assertEquals(expected, actual);
    }

    @Test
    void checkAuthorAndTitleExistence() {
        boolean expected = false;
        BookReader check = new BookReaderImpl();
        boolean actual = check.checkAuthorAndTitleExistence(emptyBook);
        assertEquals(expected, actual);
